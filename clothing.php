...
<div id="bottom_div">
 ...
 $query = "select * from clothes where rownum <=10";
$result = oci_parse($connection, $query);
oci_execute($result);

  print"<font color = \"#1E90FF\"><h2>Apparel Details</h2></font>"  ;
...
while ($row=oci_fetch_row($result))
{
  ...
  print"<td > <input type=\"checkbox\" name=\"check_list[]\" value =\"$row[3]\"/></td></tr>";
}
